...
class ListaSlides extends Lista {
	...
	public function inserir(Slide &$t){
		...
		$this->con->executar("INSERT INTO ".Sistema::$BDPrefixo.$this->tabela."(".self::TITULO.", ".self::IMAGEM.", ".self::FLASH.", ".self::SEGUNDOS.", ".self::ENDERECOURL.", ".self::ATIVO.", ".self::TIPO.", ".self::LEGENDA.", ".self::ORDEM.") VALUES('".$t->titulo."','".$imagem."','".$t->getFlash()."','".$t->segundos."','".$t->enderecoURL."','".$ativo."','".$t->tipo."','".$t->legenda."','".$t->ordem."')");
