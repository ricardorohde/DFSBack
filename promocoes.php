...
$iTM = new InterFaces(new Arquivos(Sistema::$layoutCaminhoDiretorio."promocoes.html"));

$iTM->setSESSION($_SESSION);
$iTM->trocar('lang', $_SESSION['lang']);

//metatag
$titulo = $idioma->getTraducaoByConteudo("Promoções")->traducao;
$descricao = $idioma->getTraducaoByConteudo("Promoções")->traducao;
//
